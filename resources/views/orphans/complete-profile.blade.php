<x-main-layout title="1000 أمل لأبناء الشهداء">
    ...
    <section class="mt-1">
        ...
        <div class="rounded mt-3" style="border-top-color:#f0fff4 !important">
            ...
            <div class="mt-4 mb-4 row">
                ...
                <form action="{{route('complete.profile.store', $orphan->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                                ...
                                <div class="mt-4 mb-4 ms-3 me-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                                            <x-form.input name="name" class="" type="text" id="name" value="{{$orphan->name}}" label="اسم اليتيم كامل" placeholder="ادخل الاسم" disabled/>
                                        </div>

                                        {{-- birth-date --}}
                                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                                            <x-form.input name="birth_date" value="{{$orphan->birth_date}}" type="date" id="birth-date" label="تاريخ الميلاد" disabled/>
                                        </div>

                                        {{-- id_number --}}
                                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                                            <x-form.input name="id_number" value="{{$orphan->id_number}}" type="text" id="id_number" label=" رقم هوية اليتيم " placeholder="ادخل رقم هوية اليتيم" disabled/>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                                            ...
                                            <div class="d-flex  flex-wrap gap-1 align-items-center justify-content-between">
                                                ...
                                                <div class="d-flex  gap-1">
                                                    <input class="radio-input p-0" name="orphan_status" type="radio" id="fatherless" value="يتيم الأب" />
                                ...
                                <div class="m-4">
                                    ...
                                    <div id="parent_death" style="display: none">
                                        <div class="row mb-3">
                                            ...
                                            {{-- mother-name --}}
                                            <div class="col-12 col-md-6 col-lg-4 mb-3">
                                                <x-form.input name="mother_name"  type="text" id="name" label="اسم الأم" placeholder="ادخل اسم الأم" />
                                            </div>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                var healthStatusInputs = document.querySelectorAll('input[name="health_status"]');
                var educationalStatusInputs = document.querySelectorAll('input[name="educational_status"]');

                var diseaseTypeSection = document.getElementById('disease_type');
                var academicStageSection = document.getElementById('academic_stage');
                var averageSection = document.getElementById('average1');

                // إخفاء الحقول عند التحميل
                diseaseTypeSection.style.display = 'none';
                academicStageSection.style.display = 'none';
                averageSection.style.display = 'none';

                // عند تغيير الحالة الصحية
                healthStatusInputs.forEach(function (input) {
                    input.addEventListener('change', function () {
                        if (this.value === 'مريض') {
                            diseaseTypeSection.style.display = 'block';
                        } else {
                            diseaseTypeSection.style.display = 'none';
                        }
                    });
                ...
                // عند تغيير الوضع التعليمي
                educationalStatusInputs.forEach(function (input) {
                    input.addEventListener('change', function () {
                        if (this.value === 'يدرس') {
                            academicStageSection.style.display = 'block';
