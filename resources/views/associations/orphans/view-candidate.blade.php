<x-main-layout title="1000 أمل لأبناء الشهداء">
    ...
    <div class="row background border rounded p-3">
        ...
        <div class="col-sm-12 col-md-4 col-lg-3 d-flex justify-content-between">
            <img src="{{ $orphan->image}}" alt="" width="149px" height="149px">
        </div>
            ...
            <div class="m-4">
                <div class="row mb-3">
                    ...
                    <div class="d-flex row align-items-center mb-3">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <span class="fw-bold"> حالة الملف : </span>
                            <span class="value">
                                @if ($orphan->firstReview && $orphan->firstReview->status == 'approved')
                                    تم قبول اليتيم من الباحث
                                @elseif($orphan->firstReview && $orphan->firstReview->status == 'rejected')
                                    تم رفض اليتيم
                                @endif
                            </span>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            ...
                            <span class="value"> {{@$orphan->firstReview->name}} </span>
                        </div>

                        <div class="col-12 col-md-6 col-lg-4">
                            <span class="fw-bold"> تاريخ المراجعة </span>
                            <span class="value"> {{@$orphan->firstReview->review_date}} </span>
                        </div>

                    </div>

                    <div>
                        <p class="fw-bold"> تقرير الباحث : </p>
                            <span class="value">{{@$orphan->firstReview->report}}</span>
                        </div>
                    </div>
