            ...
            <div class="mt-4 mb-4 ms-3 me-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="name" value="{{$orphan->name}}" type="text" id="name" label="اسم اليتيم كامل" placeholder="ادخل الاسم" />
                    </div>
                    ...
                    {{-- birth-place --}}
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="birth_place"  value="{{$orphan->birth_place}}" type="text" id="birth-place" label="مكان الميلاد" placeholder="ادخل مكان الميلاد"/>
                    </div>

                    {{-- country --}}
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="country" value="{{$orphan->country}}" type="text" id="country" label=" بلد اليتيم " placeholder="ادخل بلد اليتيم" />
                    </div>

                    {{-- city --}}
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="city" value="{{$orphan->city}}" type="text" id="city" label=" المنطقة / المدينة" placeholder="ادخل المدينة" />
                    </div>

                    {{-- landmark --}}
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="landmark"  value="{{$orphan->landmark}}"  type="text" id="landmark" label=" أقرب معلم " placeholder="ادخل أقرب معلم"/>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="orphan_status" type="radio" id="motherless"  value="يتيم الأم"@checked(old('orphan_status', $orphan->orphan_status) == 'يتيم الأم')/>
                                <label class="form-check-label" for="motherless" style="color: rgba(36, 36, 36, 0.6)">يتيم الأم</label>
                            </div>

                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="orphan_status" type="radio" id="fatherless"  value="يتيم الأب" @checked(old('orphan_status', $orphan->orphan_status)=='يتيم الأب')/>
                                <label class="form-check-label" for="fatherless" style="color: rgba(36, 36, 36, 0.6)">يتيم الأب</label>
                            </div>

                            <div class="d-flex gap-1">
                                <input class="radio-input p-0" name="orphan_status"  type="radio" id="orphan"  value="يتيم الأبوين" @checked(old('orphan_status', $orphan->orphan_status)=='يتيم الأبوين')/>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        ...
                        <div class="d-flex align-items-center gap-5">
                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="gender" type="radio" id="male"  value="ذكر" @checked(old('gender' , $orphan->gender)=='ذكر')/>
                                <label class="form-check-label" for="male" style="color: rgba(36, 36, 36, 0.6)"> ذكر </label>
                            </div>

                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="gender" type="radio" id="female"  value="أنثى" @checked(old('gender' , $orphan->gender)=='أنثى')/>
            ...
            <div class="m-4">
                ...
                <div id="parent_death" style="display: none">
                    <div class="row mb-3">
                        ...
                        {{-- father-name --}}
                        <div class="col-12 col-md-6 col-lg-4  mb-3">
                            <x-form.input name="father_name" value="{{$orphan->father_name}}" type="text" id="name" label="اسم الأب" placeholder="ادخل اسم الأب" />
                        </div>
                ...
                <div id="mother_death" style="display: none">
                    <div class="row mb-3">
                        ...
                        {{-- father_id_number --}}
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            <x-form.input name="father_id_number" value="{{$orphan->father_id_number}}"  type="text" id="father_id_number" label=" رقم هوية الأب "  placeholder="ادخل رقم هوية الأب "/>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-5">
                                <div class="d-flex  gap-1">
                                    <input class="radio-input p-0" name="father_marital_status" type="radio" id="Width"  value="أرمل" @checked(old('father_marital_status' , $orphan->father_marital_status)=='أرمل')/>
                                    <label class="form-check-label" for="Width" style="color: rgba(36, 36, 36, 0.6)"> أرمل </label>
                                </div>

                                <div class="d-flex gap-1">
                                    <input class="radio-input p-0" name="father_marital_status" type="radio" id="married"  value="متزوج" @checked(old('father_marital_status' , $orphan->father_marital_status)=='متزوج')/>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 mt-3">
                            <x-form.input name="father_phone"  value="{{$orphan->father_phone}}" type="text" id="father_phone" label=" رقم جوال الأب " placeholder="ادخل رقم جوال الأب " />
                        </div>
                ...
                <div id="father_death">
                    <div class="row mb-3">
                        ...
                        {{-- mother_name --}}
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            <x-form.input name="mother_name" value="{{$orphan->mother_name}}" type="text" id="mother_name" label="اسم الأم" placeholder="ادخل اسم الأم" />
                        </div>

                        {{-- mother_id_number --}}
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            <x-form.input name="mother_id_number" value="{{$orphan->mother_id_number}}" type="text" id="mother_id_number" label=" رقم هوية الأم " placeholder="ادخل رقم هوية الأم" />
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            ...
                            <div class="d-flex align-items-center row">
                                <div class="d-flex col-12 col-sm-6 gap-1">
                                    <input class="radio-input p-0" name="mother_marital_status" type="radio" id="mother_Width"  value="أرملة" @checked(old('mother_marital_status' , $orphan->mother_marital_status)=='أرملة')/>
                                    <label class="form-check-label" for="mother_Width" style="color: rgba(36, 36, 36, 0.6)"> أرملة </label>
                                </div>

                                <div class="d-flex col-12 col-sm-6 gap-1">
                                    <input class="radio-input p-0" name="mother_marital_status" type="radio" id="mother_married"  value="متزوجة" @checked(old('mother_marital_status' , $orphan->mother_marital_status)=='متزوجة')/>
                        ...
                        {{-- mother_phone --}}
                        <div class="col-12 col-md-6 col-lg-4 mt-3">
                            <x-form.input name="mother_phone"  type="text" id="mother_phone" value="{{$orphan->mother_phone}}" label=" رقم جوال الأم " placeholder="ادخل رقم جوال الأم"/>
                        </div>
                ...
                {{-- <div class="col-12 col-md-6 col-lg-4 mb-3">
                    ...
                    <div class="d-flex align-items-center row">
                        <div class="d-flex col-12 col-sm-6 gap-1">
                            <input class="radio-input p-0" name="income" type="radio" id="no_income"  value="بدون دخل" @checked(old('income' , $orphan->income)=='بدون دخل')/>
                            <label class="form-check-label" for="no_income" style="color: rgba(36, 36, 36, 0.6)"> بدون دخل </label>
                        </div>

                        <div class="d-flex col-12 col-sm-6 gap-1">
                            <input class="radio-input p-0" name="income" type="radio" id="fixed_income"  value="دخل ثايت" @checked(old('income' , $orphan->income)=='دخل ثايت')/>
                ...
                <div class="row mb-3">
                    ...
                    {{-- <div class="col-12 col-md-6 col-lg-4 mb-3 income">
                        <x-form.input name="income_value" value="{{$orphan->income_value}}" type="text" label=" القيمة المالية للدخل " placeholder="ادخل القيمة المالية للدخل" />
                    </div>

                    <!-- income_source -->
                    <div class="col-12 col-md-6 col-lg-4 mb-3 income">
                        <x-form.input name="income_source" value="{{$orphan->income_source}}" type="text" label=" مصدر الدخل " placeholder="ادخل مصدر الدخل" />
                    </div> --}}
        ...
        <div class="border border-1 rounded" style="border-top-color:#f0fff4 !important">
            ...
            <div class="m-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="guardian_first_phone" value="{{$orphan->profile?->guardian_first_phone}}" type="text" id="guardian_first_phone" label=" رقم الجوال الأول " placeholder="ادخل رقم الجوال الأول " />
                    </div>
            ...
            <div class="m-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="d-flex align-items-center gap-5">
                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="health_status" type="radio" id="health-good"  value="جيد" @checked(old('health_status' , $orphan->profile?->health_status)=='جيد')/>
                                <label class="form-check-label" for="health-good" style="color: rgba(36, 36, 36, 0.6)"> جيد </label>
                            </div>

                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="health_status" type="radio" id="health-sick"  value="مريض" @checked(old('health_status' , $orphan->profile?->health_status)=='مريض')/>
                    ...
                    <div id="disease_type" class="row">
                        ...
                        <div class="col-12">
                                ...
                                <div class="d-flex row align-items-center mb-3">
                                    <div class="d-flex col-12 col-sm-6  col-md-4 gap-1">
                                        <input class="radio-input p-0" name="disease_type" type="radio" id="good"  value="مرض عادي" @checked(old('disease_type' , $orphan->profile?->disease_type)=='مرض عادي')/>
                                        <label class="form-check-label" for="good" style="color: rgba(36, 36, 36, 0.6)"> مرض عادي </label>
                                    </div>

                                    <div class="d-flex col-12 col-sm-6 col-md-4 gap-1">
                                        <input class="radio-input p-0" name="disease_type" type="radio" id="chronic_disease"  value="مرض مزمن"  @checked(old('disease_type' , $orphan->profile?->disease_type)=='مرض مزمن')/>
                                        <label class="form-check-label" for="chronic_disease" style="color: rgba(36, 36, 36, 0.6)"> مرض مزمن </label>
                                    </div>

                                    <div class="d-flex col-12 col-sm-6 col-md-4 gap-1">
                                        <input class="radio-input p-0" name="disease_type" type="radio" id="incurable_disease"  value="مرض عضال"  @checked(old('disease_type' ,$orphan->profile?->disease_type)=='مرض عضال')/>
                        ...
                        <div class="col-12">
                            <div class="w-100">
                                <x-form.input value="{{$orphan->profile?->not_available_medical_report}}" name="not_available_medical_report"  type="text" id="not_available_medical_report" label=" في حالة عدم توفر الملف, يرجى ادخال السبب " placeholder="ادخل الرسالة" />
                            </div>
                        </div>
            ...
            <div class="m-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="d-flex align-items-center row">
                            <div class="d-flex col-12 col-sm-6 col-md-4 gap-1">
                                <input class="radio-input p-0" name="educational_status" type="radio" id="underschool"  value="دون سن الدراسة"  @checked(old('educational_status' , $orphan->profile?->educational_status)=='دون سن الدراسة')/>
                                <label class="form-check-label" for="underschool" style="color: rgba(36, 36, 36, 0.6)">  دون سن الدراسة </label>
                            </div>

                            <div class="d-flex col-12 col-sm-6 col-md-4 gap-1">
                                <input class="radio-input p-0" name="educational_status" type="radio" id="study"  value="يدرس" @checked(old('educational_status' , $orphan->profile?->educational_status)=='يدرس')/>
                                <label class="form-check-label" for="study" style="color: rgba(36, 36, 36, 0.6)"> يدرس </label>
                            </div>

                            <div class="d-flex col-12 col-sm-6 col-md-4 gap-1">
                                <input class="radio-input p-0" name="educational_status" type="radio" id="no_study"  value="لا يدرس" @checked(old('educational_status' , $orphan->profile?->educational_status)=='لا يدرس')/>
                    ...
                    <div class="col-12" id="academic_stage">
                        ...
                        <div class="d-flex align-items-center gap-5">
                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="academic_stage" type="radio" id="primary"  value="ابتدائي" @checked(old('academic_stage' , $orphan->profile?->academic_stage)=='ابتدائي')/>
                                <label class="form-check-label" for="primary" style="color: rgba(36, 36, 36, 0.6)"> ابتدائي </label>
                            </div>

                            <div class="d-flex  gap-1">
                                <input class="radio-input p-0" name="academic_stage" type="radio" id="preparatory"  value="اعدادي" @checked(old('academic_stage' , $orphan->profile?->academic_stage)=='اعدادي')/>
                    ...
                    <div class="col-12 mt-3" id="average1">
                        <div class="w-100">
                            <x-form.input value="{{$orphan->profile?->average}}" name="average" type="text" id="average" label=" المعدل (ان وجد ) " placeholder="ادخل المعدل" />
                        </div>
                    </div>
        ...
        <div class="border border-1 rounded" style="border-top-color:#f0fff4 !important">
            ...
            <div class="m-4">
                ...
                <div class="row mb-3">
                    {{-- sibling_count --}}
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="male_number" min="0"  type="number" id="male_number" label=" عدد الإخوة الذكور" placeholder="ادخل عدد الإخوة " value="{{$orphan->sibling?->male_number}}" />
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <x-form.input name="female_number" min="0"  type="number" id="female_number" label=" عدد الإخوة الإناث" placeholder="ادخل عدد الإخوات " value="{{$orphan->sibling?->female_number}}" />
                    </div>
            </div>
        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3 ms-3">
                        ...
                        <div class="d-flex row align-items-center gap-2">
                            <div class="d-flex col-12 col-sm-6 col-md-2 gap-1">
                                <input class="radio-input p-0" name="receive_guarantee" type="radio" id="bank"  value="bank"  onchange="toggleReceiveDivs()" @checked(old('receive_guarantee' , $orphan->profile?->receive_guarantee)=='bank')/>
                            ...
                            <div class="d-flex col-12 col-sm-6 col-md-3 gap-1">
                                <input class="radio-input p-0" name="receive_guarantee" type="radio" id="wallet"  value="wallet"  onchange="toggleReceiveDivs()" @checked(old('receive_guarantee' , $orphan->profile?->receive_guarantee)=='wallet')/>
                    ...
                    <div id="receive-bank" style="display: none">
                        ...
                        <div class="d-flex row align-items-center mb-3">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-3">
                                <x-form.input name="account_number" class="" type="text" id="account_number" label=" رقم الحساب " placeholder="ادخل رقم الحساب" value="{{$orphan->profile?->account_number}}"/>
                            </div>
                    ...
                    <div id="receive-wallet" style="display: none">
                        ...
                        <div class="d-flex align-items-center row mb-3">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-3">
                                <x-form.input name="wallet_number" class="" type="text" id="wallet_number" label=" رقم المحفظة " value="{{$orphan->profile?->wallet_number}}" placeholder="ادخل رقم المحفظة " />
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-3">
                                <x-form.input name="wallet_owner" class="" type="text" id="wallet_owner" label=" اسم صاحب المحفظة " value="{{$orphan->profile?->wallet_owner}} placeholder="ادخل اسم صاحب المحفظة  " />
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-3">
                                <x-form.input name="wallet_owner_id_number" class="" type="text" id="wallet_owner_id_number" value="{{$orphan->profile?->wallet_owner_id_number}}" label=" رقم هوية صاحب المحفظة " placeholder="ادخل رقم هوية صاحب المحفظة" />
                            </div>
