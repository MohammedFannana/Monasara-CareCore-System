<x-main-layout title="1000 أمل لأبناء الشهداء">
    ...
    <div class="header fw-bold" style="color: var(--primary-color);font-size:18px;  border-top-right-radius: 6px;border-top-left-radius:6px; padding:10px;background:linear-gradient(to left , #c6fdda , #edfaf1)">
        ...
        <p class="color-text fw-normal mt-2" style="font-size: 15px">
            يعرض هذا القسم تقارير المالية المسجلين في النظام، حيث يمكنك الاطلاع على تقاريرهم.  مما يسهل عملية الإشراف والإدارة بشكل شامل ومنظم.
        </p>
    </div>
        ...
        <div class="rounded">
            ...
            <div class="mt-4">
                ...
                <div class="d-flex justify-content-between mb-3">
                    <p class="fs-5 fw-semibold"> قائمة التقارير المالية </p>
                    <!-- Dropdown Button -->
                    <div class="dropdown">
                            ...
                            <form id="exportForm" method="POST" action="">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" class="form-control" name="type" value="financial" id="type">
                ...
                @if ($reports->isNotEmpty())
                    <form action="{{route('admin.report.financial')}}" method="GET" class="search custom-sm-style w-100">
            ...
            <div class="row">
                ...
                @empty
                    ...
                    <div class="col-12 text-white text-center rounded p-2" style="background-color: var(--primary-color)"> لا يوجد تقارير مالية لعرضها </div>
